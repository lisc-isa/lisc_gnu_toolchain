...
build:
	...
	cd toolcahin-patches && tar mcvfz toolchain-patches_delta.tar.gz * && cp toolchain-patches_delta.tar.gz $(CURDIR)/riscy_gnu_toolchain && rm toolchain-patches_delta.tar.gz
